...
namespace Distrib.Plugins.Discovery.Metadata
{
        ...
        : IDistribPluginAdditionalMetadataBundle
    {
        ...
        private readonly AdditionalMetadataIdentityExistencePolicy m_enumExistencePolicy = AdditionalMetadataIdentityExistencePolicy.NotImportant;
        ...
        internal ConcreteDistribPluginAdditionalMetadataBundle(Type interfaceType, 
            Type attributeType, object metadataObject, Dictionary<string, object> kvps, string identity, AdditionalMetadataIdentityExistencePolicy existencePolicy)
        {
        ...
        public AdditionalMetadataIdentityExistencePolicy MetadataInstanceExistencePolicy
        {
