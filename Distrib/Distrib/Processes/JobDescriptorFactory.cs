...
namespace Distrib.Processes
{
    ...
    public sealed class JobDescriptorFactory : CrossAppDomainObject, IJobDescriptorFactory
    {
        ...
        public JobDescriptorFactory(IIOC ioc)
        {
            _ioc = ioc;
        }
        ...
        {
            return _ioc.Get<IJobDescriptor>(new[]
            {
                new IOCConstructorArgument("jobName", definition.Name),
                new IOCConstructorArgument("inputFields", definition.InputFields),
                new IOCConstructorArgument("outputFields", definition.OutputFields),
            });
        }
    }
}
