...
namespace Distrib.Separation
{
    public sealed class SeparateInstanceCreatorFactory : ISeparateInstanceCreatorFactory
    {
        ...
        public SeparateInstanceCreatorFactory(IIOC ioc)
        {
            _ioc = ioc;
        }
        ...
        {
            return _ioc.Get<ISeparateInstanceCreator>(new[]
            {
                new IOCConstructorArgument("iocHasType", new Func<Type, bool>((t) => 
                    {
                        return _ioc.IsTypeBound(t);
                    })),

                new IOCConstructorArgument("iocGetInstance", new Func<Type, object>((t) => _ioc.Get(t))),
            });
        }
    }
}
