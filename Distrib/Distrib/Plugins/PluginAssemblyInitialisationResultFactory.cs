...
namespace Distrib.Plugins
{
    public sealed class PluginAssemblyInitialisationResultFactory : IPluginAssemblyInitialisationResultFactory
    {
        ...
        public PluginAssemblyInitialisationResultFactory(IIOC ioc)
        {
            _ioc = ioc;
        }
        ...
        {
            return _ioc.Get<IPluginAssemblyInitialisationResult>(new[]
            {
                new IOCConstructorArgument("descriptorList", descriptorList),
            });
        }
    }
}
