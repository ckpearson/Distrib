...
{
    public interface IPluginAssemblyInitialisationResultFactory
    {
        IPluginAssemblyInitialisationResult CreateResultFromPlugins(IReadOnlyList<IPluginDescriptor> descriptorList);
    }
}
