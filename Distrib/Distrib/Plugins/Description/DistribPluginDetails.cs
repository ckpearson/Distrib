...
namespace Distrib.Plugins.Description
{
    ...
    //    private readonly WriteOnce<PluginExclusionReason> m_pluginExclusionReason =
    ...
    //    private readonly WriteOnce<List<IPluginAdditionalMetadataBundle>>
    //        m_lstAdditionalMetadata = new WriteOnce<List<IPluginAdditionalMetadataBundle>>(null);
    ...
    //    internal PluginDetails(string pluginTypeName, DistribPluginMetadata metadata)
    //    {
    ...
    //    /// </summary>
    //    public List<IPluginAdditionalMetadataBundle> AdditionalMetadataBundles
    //    {
    //        get
    //        {
    ...
    //            m_pluginExclusionReason.Value = PluginExclusionReason.Unknown;
    //        }
    //    }
    ...
    //    internal void MarkAsUnusable(PluginExclusionReason exclusionReason,
    //        object tag = null)
    //    {
    //        lock (m_lock)
    //        {
