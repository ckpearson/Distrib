...
{
    public sealed class PluginAssemblyStateChangeEvent : CompositePresentationEvent<PluginAssemblyStateChange>
    {
    }

    public enum PluginAssemblyStateChange
    {
        AssemblyLoaded,
        AssemblyUnloaded,
        AssemblyInitialised,
        AssemblyUninitialised,
    }
}
